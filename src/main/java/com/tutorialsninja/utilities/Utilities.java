...
public class Utilities extends ManageBrowser
{
    ...
    public static String getAlphaNumericString(int n)
    {
        ...
        String AlphaNumericaString ="ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "0123456789"
        ...
        for(int i=0; i<n; i++)
        {
            ...
            int index = (int)(AlphaNumericaString.length() * Math.random());
            // add Character one by one in end of sb
            sb.append(AlphaNumericaString.charAt(index));
        }
        return sb.toString();
    }
